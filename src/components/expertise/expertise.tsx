...
export function Expertise() {
  return (
    <section>
      <div className="max-w-screen-xl px-4 py-8 mx-auto lg:py-10">
        <div className="mr-auto place-self-center lg:col-span-7">
          <h1 className="max-w-2xl mb-12 text-4xl tracking-tight md:text-5xl dark:text-white">
            Expertise
          </h1>
          ...
          <div className="flex space-x-10 mb-10">
            <Link
              ...
              target="_blank"
              className="border rounded px-6 py-2 border-palette-red hover:bg-palette-brown hover:text-white"
            >
              Next
            </Link>
            <Link
